...
|--------|------------|-----------------|----------------------|-----------------------------------------------------|-------------|---------------------|
| `1.0`  | 07/05/2025 | 08/05/2025 | Criação do documento/template e inserção do diagrama de componentes | [Arthur Sousa](https://github.com/arthurrsousa), [Amanda Abreu](https://github.com/Amandaaaaabreu)  |[Esther Sousa](https://github.com/) | Foi revisado e corrigido alguns detalhes nas descrições |
| `1.1`  | 08/05/2025 | 08/05/2025 | Inserção do Diagrama de Classes | [Arthur Heleno](https://github.com/arthur-heleno) |[Esther Sousa](https://github.com/) | Foi revisado e corrigido alguns detalhes nas descrições |
